...
if(isset($_GET['adminId'])) {
	$adminModel->delete($_GET['adminId']);
}
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
	...
	<h3>Admin List</h3>
<a class="create_button" href="adminCreate.php">Create Admin</a>
<table border="1">
	<tr>
		<th>Admin Id</th>
		<th>Admin Login</th>
	...
	<?php foreach ($admins as $admin) { ?>
		<tr>
			...
			<td><?php echo $admin->adminLogin; ?></td>
			<td><?php echo $admin->adminPassword; ?></td>
			<td>
				<a href="adminUpdate.php?adminId=<?php echo $admin->adminId; ?>">Edit</a>
				</td>
			<td>
				<a href="adminIndex.php?adminId=<?php echo $admin->adminId; ?>" onclick="return confirm('You are about to delete an admin. Are you sure?')">Delete</a>
			</td>
		</tr>
	<?php }?>
</table>
