...
if(isset($_POST['saveButton'])){
	$adminModel->update($_POST);
	header('Location:adminIndex.php');
}
$result = $adminModel->find($_GET['adminId']);
$admins = json_decode($result['response']);
?>
...
<form method="post">
	<table>
		<tr>
			<td>Admin Id</td>
			<td><input type="number" name="adminId" required="required" 
			value="<?php echo $admin->adminId; ?>" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>Admin Login</td>
			<td><input type="number" name="adminLogin" required="required" 
			value="<?php echo $admin->adminLogin; ?>" autocomplete="off"/>
			</td>
		</tr>
		<tr>
			<td>Admin Password</td>
			<td><input type="text" name="adminPassword" required="required"
			value="<?php echo $admin->adminPassword; ?>" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
