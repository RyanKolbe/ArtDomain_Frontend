...
if(isset($_GET['addressId'])) {
	$addressModel->delete($_GET['addressId']);
}
$result = $addressModel->findAll();
$addresses = (json_decode($result['response']));
?>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
	...
	<h3>Address List</h3>
<a class="create_button" href="addressCreate.php">Create Address</a>
<table border="1">
	<tr>
		<th>Adress Id</th>
		<th>Street Name</th>
	...
	<?php foreach ($addresses as $address) { ?>
		<tr>
			...
			<td><?php echo $address->streetName; ?></td>
			<td><?php echo $address->streetNumber; ?></td>
			<td><?php echo $address->streetType; ?></td>
			<td>
				<a href="addressUpdate.php?addressId=<?php echo $address->addressId; ?>">Edit</a>
				</td>
			<td>
				<a href="addressIndex.php?addressId=<?php echo $address->addressId; ?>" onclick="return confirm('You are about to delete an address. Are you sure?')">Delete</a>
			</td>
		</tr>
	<?php }?>
</table>
