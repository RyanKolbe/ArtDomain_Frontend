...
<form method="post">
	<table>
		<tr>
			<td>Address Id</td>
			<td><input type="number" name="addressId" required="required" autocomplete="off" /></td>
		</tr>
		<tr>
			<td>Street Number</td>
			<td><input type="text" name="streetNumber" required="required" autocomplete="off"/></td>
		</tr>
				<tr>
			<td>Street Name</td>
			<td><input type="text" name="streetName" required="required" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>Street Type</td>
			<td><input type="text" name="streetType" required="required" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
