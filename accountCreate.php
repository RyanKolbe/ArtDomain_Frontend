...
<form method="post">
	<table>
		<tr>
			<td>Account Id</td>
			<td><input type="number" name="accountId" required="required" autocomplete="off" /></td>
		</tr>
		<tr>
			<td>Account Number</td>
			<td><input type="number" name="accountNumber" required="required" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>Account Name</td>
			<td><input type="text" name="accountName" required="required" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>Account Category</td>
			<td><input type="text" name="accountCategory" required="required" autocomplete="off"/></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
